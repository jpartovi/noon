...
@router.post("/otp", response_model=auth_schema.OTPInitResponse, status_code=status.HTTP_202_ACCEPTED)
...
async def verify_otp(payload: auth_schema.OTPVerifyRequest) -> auth_schema.OTPVerifyResponse:
    try:
